...
$records=mysqli_query($link,"SELECT * FROM `feedbackfromexstudents` WHERE 1");
...
<div class="main_bg"><!-- start main -->
	<div class="container" style="overflow-y:scroll;height:1000px">
		<div class="main row">
        ...
        if($student['permission']=="1"){
			echo '<div class="col-md-8 blog_left">
				<h2>'.$student['name'].'</h2>
				<img src="'.$student['image'].' " alt="logo3.jpg" style="max-width: 50vh;max-height: 50vh;"/>
				<div class="blog_list">
...
<div class="container" style="background-color:#e3e3e3e3" id="fform">
  ...
  <div class="form-group">
      <label for="pwd"><b>Upload Photo:<b></label>
      <input type="file" class="form-control"  placeholder="Upload Image" name="afile">
    </div>
